...
public class AddressResourceIntTest {
    ...
    public void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.content[*].id").value(hasItem(address.getId())))
            .andExpect(jsonPath("$.content[*].street").value(hasItem(DEFAULT_STREET.toString())))
            .andExpect(jsonPath("$.content[*].number").value(hasItem(DEFAULT_NUMBER.toString())))
            .andExpect(jsonPath("$.content[*].zipcode").value(hasItem(DEFAULT_ZIPCODE.toString())))
            .andExpect(jsonPath("$.content[*].district").value(hasItem(DEFAULT_DISTRICT.toString())))
            .andExpect(jsonPath("$.content[*].complement").value(hasItem(DEFAULT_COMPLEMENT.toString())));
    }
    ...
    public void updateAddress() throws Exception {
        ...
        restAddressMockMvc.perform(put("/api/addresses/{id}", address.getId())
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(addressDTO)))
            .andExpect(status().isOk());
    ...
    public void updateNonExistingAddress() throws Exception {
        ...
        restAddressMockMvc.perform(put("/api/addresses/{id}", "NOPE")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(addressDTO)))
            .andExpect(status().isCreated());
