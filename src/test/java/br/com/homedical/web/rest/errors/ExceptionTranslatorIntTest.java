...
public class ExceptionTranslatorIntTest {
    ...
    public void testConcurrencyFailure() throws Exception {
        mockMvc.perform(get("/test/concurrency-failure"))
            ...
            .andExpect(jsonPath("$.message").value(ApplicationErrorConstants.ERR_CONCURRENCY_FAILURE));
    }
    ...
    public void testMethodArgumentNotValid() throws Exception {
         mockMvc.perform(post("/test/method-argument").content("{}").contentType(MediaType.APPLICATION_JSON))
             ...
             .andExpect(jsonPath("$.message").value(ApplicationErrorConstants.ERR_VALIDATION))
    ...
    public void testAccessDenied() throws Exception {
        mockMvc.perform(get("/test/access-denied"))
            ...
            .andExpect(jsonPath("$.message").value(ApplicationErrorConstants.ERR_ACCESS_DENIED))
    ...
    public void testMethodNotSupported() throws Exception {
        mockMvc.perform(post("/test/access-denied"))
            ...
            .andExpect(jsonPath("$.message").value(ApplicationErrorConstants.ERR_METHOD_NOT_SUPPORTED))
    ...
    public void testInternalServerError() throws Exception {
        mockMvc.perform(get("/test/internal-server-error"))
            ...
            .andExpect(jsonPath("$.message").value(ApplicationErrorConstants.ERR_INTERNAL_SERVER_ERROR))
