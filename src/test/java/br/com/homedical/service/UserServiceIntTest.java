...
public class UserServiceIntTest {
    ...
    public void assertThatUserMustExistToResetPassword() {
        Optional<User> maybeUser = Optional.ofNullable(userService.requestPasswordReset("john.doe@localhost"));
        assertThat(maybeUser.isPresent()).isFalse();

        maybeUser = Optional.ofNullable(userService.requestPasswordReset("admin@localhost"));
