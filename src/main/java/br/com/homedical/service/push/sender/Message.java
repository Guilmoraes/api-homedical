...
public final class Message implements Serializable {
    ...
    public static final class Builder {
        ...
        public Builder priority(Priority value) {
            switch (value) {
                case NORMAL:
                    priority = br.com.homedical.service.push.sender.Constants.MESSAGE_PRIORITY_NORMAL;
                    break;
                case HIGH:
                    priority = br.com.homedical.service.push.sender.Constants.MESSAGE_PRIORITY_HIGH;
                    break;
            }
            return this;
        }
    ...
    private Message(Builder builder) {
        ...
        pushNotification = builder.pushNotification;
    }
    ...
    public String toString() {
        ...
        if (pushNotification != null) {
            builder.append("notification: ").append(pushNotification).append(", ");
        }
        if (!data.isEmpty()) {
            builder.append("data: {");
