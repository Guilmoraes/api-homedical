package br.com.homedical.security.jwt;
...
public class TokenProvider {
    ...
    public String createToken(String user, Set<Authority> authoritySet, Boolean rememberMe) {
        String authorities = authoritySet.stream()
